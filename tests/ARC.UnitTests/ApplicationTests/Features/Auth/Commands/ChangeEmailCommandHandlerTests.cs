...
using ARC.Application.Features.Auth.Commands.ChangeEmail;
using ARC.Tests.Common.DataGenerators;

namespace ARC.Application.Tests.Features.Auth.Commands
{
    public class ChangeEmailCommandHandlerTests : IClassFixture<LocalizationKeyFixture>
    {
        ...
        private readonly Mock<IStringLocalizer<ChangeEmailCommandHandler>> _localizerMock;
        ...
        public ChangeEmailCommandHandlerTests()
        {
            ...
            _localizerMock = new Mock<IStringLocalizer<ChangeEmailCommandHandler>>();

...
namespace ARC.Tests.Common.Layers
{
    /// <summary>
    ...
    {
        protected const string APIAssemblyName = "ARC.API";
        protected const string ApplicationAssemblyName = "ARC.Application";
        protected const string DomainAssemblyName = "ARC.Domain";
        protected const string InfrastructureAssemblyName = "ARC.Infrastructure";
        protected const string PersistenceAssemblyName = "ARC.Persistence";

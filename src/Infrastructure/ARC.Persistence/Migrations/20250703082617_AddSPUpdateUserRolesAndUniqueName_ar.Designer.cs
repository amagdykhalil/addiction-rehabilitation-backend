...
namespace ARC.Persistence.Migrations
{
    ...
    [Migration("20250703082617_AddSPUpdateUserRolesAndUniqueName_ar")]
    partial class AddSPUpdateUserRolesAndUniqueName_ar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ARC.Domain.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ARC.Domain.Entities.Role", null)
                        .WithMany()
